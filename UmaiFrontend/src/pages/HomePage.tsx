    ...
    <>
      ...
      <div className="mx-auto max-w-6xl space-y-16 px-5 pb-20">
        <section aria-labelledby="diet-heading">
          <SectionHeading id="diet-heading" title="対応で探す" />
            ...
            {FILTERABLE_VEGETARIAN_TYPES.map((type, index) => (
              ...
              >
                <Link
                  ...
                  className="sketchy-edge-strong flex items-center justify-between rounded-cozy border border-cream-200 bg-white px-5 py-4 shadow-soft transition-all hover:-translate-y-0.5 hover:border-leaf-300 hover:shadow-lifted"
                >
        ...
        <section aria-labelledby="cuisine-heading">
          <SectionHeading id="cuisine-heading" title="ジャンルで探す" action={{ to: '/categories', label: 'すべて見る' }} />
        ...
        <section aria-labelledby="featured-heading">
          <SectionHeading id="featured-heading" title="評価の高いお店" action={{ to: '/search', label: 'もっと見る' }} />
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-leaf-50 to-cream-50 px-5 py-16 sm:py-24">
      ...
      >
        ...
        <h1 className="font-display mt-6 text-4xl leading-snug tracking-tight text-bark-800 sm:text-5xl">
          東京で、あなたにぴったりの
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-3">
          <Link
            to="/map"
            className="font-display inline-flex items-center gap-2 rounded-pill bg-white px-6 py-3 text-bark-800 shadow-soft transition-all hover:-translate-y-0.5 hover:shadow-lifted"
          >
...
function SectionHeading({ id, title, subtitle, action }: SectionHeadingProps) {
  return (
    <div className="flex flex-wrap items-end justify-between gap-3">
      <div>
        <h2 id={id} className="font-display text-2xl text-bark-800">
          {title}
        </h2>
